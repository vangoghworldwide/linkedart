...
The starting point of Van Gogh Worldwide is the set of artworks defined in *The Works of Vincent van Gogh: His Paintings and Drawings* by Jacob Baart de la Faille (1970). Basic metadata of all artworks in de la Faille is provided as [open data](https://data.spinque.com/ld/data/vangoghworldwide/de_la_faille_1970/). You can help extend this basic metadata with information about the production, titles, materials, exhibitions, literature, research and more. 
